/**
 * Common test utilities, fixtures, and mock factories
 *
 * Centralizes test data and helper functions used across multiple test files
 */
import type { DiscogsRelease, QueueItem, Settings, DiscogsTrack, Credentials } from '@libs';
