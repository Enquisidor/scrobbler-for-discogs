...
export const AppleMusicIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FA243C" {...props}>
    <title>Apple Music</title>
  </svg>
);

export const MusicBrainzIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#BA478F" {...props}>
    <title>MusicBrainz</title>
  </svg>
);

export const DeezerIcon = (props: React.SVGProps<SVGSVGElement>) => (
  <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#FEAA2D" {...props}>
    <title>Deezer</title>
  </svg>
);
