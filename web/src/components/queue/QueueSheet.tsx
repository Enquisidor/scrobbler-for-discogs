...
interface QueueSelectionProps {
  ...
  onFeatureToggle: (instanceKey: string, trackKey: string, featuredArtistNames: string[], albumArtistNames: string[]) => void;
      ...
      {itemsToDisplay.length > 0 ? (
        itemsToDisplay.map(item => (
          <QueueItem
            ...
            onFeatureToggle={(trackKey, featuredArtistNames, albumArtistNames) => onFeatureToggle(item.instanceKey, trackKey, featuredArtistNames, albumArtistNames)}
